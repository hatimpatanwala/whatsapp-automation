  ...
  readonly helpGroups: Array<{ title: string; keys: Array<[string, string]> }> = [
    ...
    },
    {
      ...
      keys: [
        ...
        ['Alt+V', 'Registers (sales/purchase/quote/order)'], ['Alt+A', 'Outstanding (ageing)'],
        ['Ctrl+G', 'GST Returns'],
  ...
  readonly menus: MenuGroup[] = [
    {
      ...
      entries: [
        ...
        { label: 'Party Ledger (statement)', route: '/accounting/reports/ledger' },
    ...
    },
    {
      ...
      entries: [
        ...
        { label: 'Returns (CN / DN)', route: '/entry/returns', key: 'Alt+N' },
        { label: 'Stock Journal / Transfer', route: '/entry/stock', key: 'Alt+J' },
      ],
    },
    {
      title: 'GST',
    ...
    },
    {
      ...
      entries: [
        ...
        { label: 'Bills Outstanding (Ageing)', route: '/accounting/reports/ageing', key: 'Alt+A' },
