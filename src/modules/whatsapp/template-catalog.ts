...
export const TEMPLATE_TEXT: Record<string, TemplateText> = {
  order_confirmation: { body: "Hi {{1}}, your order #{{2}} has been confirmed! {{3}} items totalling {{4}}. We'll notify you when it ships. Thank you for shopping with us!", footer: 'Powered by NexusFlow' },
  order_shipped: { body: 'Hi {{1}}, great news! Your order #{{2}} has been shipped. {{3}} Track your delivery or reply here for updates.', footer: 'Powered by NexusFlow' },
  order_delivered: { body: 'Hi {{1}}, your order #{{2}} has been delivered! We hope you love it. Reply "HELP" if you have any issues or "REORDER" to place a new order.', footer: 'Powered by NexusFlow' },
  order_cancelled: { body: 'Hi {{1}}, your order #{{2}} has been cancelled. {{3}} If you have any questions, reply to this message.', footer: 'Powered by NexusFlow' },
  payment_received: { body: "Hi {{1}}, we've received your payment of {{2}} for order #{{3}}. Your order is now being processed. Thank you!", footer: 'Powered by NexusFlow' },
  payment_verified: { body: 'Hi {{1}}, your payment of {{2}} for order #{{3}} has been verified. Your order will be shipped soon!', footer: 'Powered by NexusFlow' },
  payment_reminder: { body: 'Hi {{1}}, a friendly reminder that payment of {{2}} is pending for your order #{{3}}. Please complete the payment to avoid cancellation. Reply "PAY" for payment options.', footer: 'Powered by NexusFlow' },
  payment_refunded: { body: 'Hi {{1}}, your refund of {{2}} for order #{{3}} has been processed. It may take 3-5 business days to reflect in your account. Reply if you need any help.', footer: 'Powered by NexusFlow' },
  delivery_update: { body: 'Hi {{1}}, delivery update for order #{{2}}: {{3}}. {{4}} — reply here if you need any help.', footer: 'Powered by NexusFlow' },
  delivery_failed: { body: 'Hi {{1}}, we were unable to deliver your order #{{2}}. Reason: {{3}}. We\'ll retry delivery tomorrow. Reply "RESCHEDULE" to pick a new time or "PICKUP" for self-collection.', footer: 'Powered by NexusFlow' },
